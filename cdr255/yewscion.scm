...
(define-public genpro
  (let ((commit "3620ee605559393a6211163803ad5538c05e7dd0")
        (revision "1"))
    (package
      (name "genpro")
      ...
      (source
       (origin
         ...
         (sha256
          (base32
           "0zigf6dy53xnv8mf762r5xs3614naw14758n31b36xi24528rpl1"))))
...
(define-public yewscion-scripts
  (let ((commit "f80c8835034ff026665d8696a83e2bc36a8e8f62")
        (revision "1"))
    (package
      ...
      (source
       (origin
         ...
         (sha256
          (base32
           "0wp418accnc30a9kmfyfcc8a1jlcdcdgjdy2v90cpqmvskvlpc26"))))
      (build-system gnu-build-system)
      (arguments
