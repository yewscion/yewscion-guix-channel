  ...
  (package
    ...
    (source (origin
              ...
              (uri (git-reference
                    ...
                    (commit "bbaa68d1aa225d36e08d9b736b69984e1321ac61")))
              (file-name (git-file-name name version))
              (sha256
               (base32
                "0649qq27z4dyhks6zfyd2myzd53jisparrcr7svk1rldcr6azrc7"))))
    (build-system gnu-build-system)
    (arguments
     `(#:modules
       ((ice-9 match)
...
(define-public yewscion-scripts
  (let ((commit "41443a5856392b4b73b9d82de76d0ffae0f6b3bb")
        (revision "1"))
    (package
      ...
      (source
       (origin
         ...
         (sha256
          (base32
           "1ibdd8j2y7hwf0z6wim6crx8csvr9b5a9537172ynrvp84v097q1"))))
      (build-system gnu-build-system)
