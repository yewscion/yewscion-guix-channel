...
(define-public genpro
  (let ((commit "f1881550b3a4354b9c6acfd4fb66d0802c41b600")
        (revision "1"))
    (package
      (name "genpro")
      ...
      (source
       (origin
         ...
         (sha256
          (base32
           "09xxq5w8j1w68gad6d0ckz5rhcw9d9q44wllp03sr07p1darcrid"))))
...
(define-public guile-cdr255
  (let ((commit "31e69c556401ede2ec2bb4204c1b6b41396e8509")
        (revision "1"))
    (package
      (name "guile-cdr255")
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "156r2fxw98lla7j2il85i610mh38bnmvjcgphi4nwapmwn7xzzd9"))))
      (build-system gnu-build-system)
      (arguments
       `(#:phases
         (modify-phases
...
(define-public yewscion-scripts
  (let ((commit "61243cfdfb167d3017165e9bd22f50ea35624e85")
        (revision "1"))
    (package
      ...
      (source
       (origin
         ...
         (sha256
          (base32
           "0hg93dmn2bywa3m3fbdyj5yjj4agfg9bh0hzihh19la7jw2m7zbn"))))
      (build-system gnu-build-system)
      (arguments
       `(#:phases
         (modify-phases
