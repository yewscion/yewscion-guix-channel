  ...
  (package
    ...
    (source (origin
              ...
              (uri (git-reference
                    ...
                    (commit "641b3e7047409afe8929508de39b552d68ddda0b")))
              (file-name (git-file-name name version))
              (sha256
               (base32
                "1kf31a5xrj0ls2w9113f3j0n3zmzrf5x3xlw08wfmkdp6y45df3y"))))
    (build-system gnu-build-system)
    (arguments
     `(#:modules
       ((ice-9 match)
...
(define-public yewscion-scripts
  (let ((commit "4baea146dfb05531d86f849b7bbe9539beb27299")
        (revision "1"))
    (package
      ...
      (source
       (origin
         ...
         (sha256
          (base32
           "0axdr039vm4770xar7qh6zyl9c0mds6fb8jmann4ma3ksm5dn1mb"))))
      (build-system gnu-build-system)
      (arguments
       `(#:tests? #f))
      (native-inputs (list pkg-config
