...
(define-public guile-cdr255
  (let ((commit "45adde8d6a81c992c849ce36ec40d091b8058f39")
        (revision "1"))
    (package
     (name "guile-cdr255")
     ...
     (source (origin
              ...
              (sha256
               (base32
                "1gvpsh4mbwz5swkqr4irncl9gjabl0lqnxzna9yncr5wdxyv9czx"))))
     (build-system gnu-build-system)
     (arguments
      `(#:phases
        (modify-phases
...
(define-public yewscion-scripts
  (let ((commit "f26316092d28c0ba615c5bbe8960acdb061c89f3")
        (revision "1"))
    (package
     ...
     (source
      (origin
       ...
       (sha256
        (base32
         "0p5bf4nz2janbxps6lv3bl7ivzhd8v22nqvsa815c6m5527fwssb"))))
     (build-system gnu-build-system)
     (arguments
