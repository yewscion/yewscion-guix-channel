...
(define-public genpro
  (let ((commit "d0a762384b29de70c3af1f64a00f205463a8ea46")
        (revision "1"))
    (package
     (name "genpro")
     ...
     (source
      (origin
       ...
       (sha256
        (base32
         "1plgkd8y4x04d16hpaph08cv7lm0ihlcak60ac506z6j55yvjhl9"))))
...
(define-public yewscion-scripts
  (let ((commit "f2de8d4ae7968cae42b3d20dc40c82fbd5edde1a")
        (revision "1"))
    (package
     ...
     (source
      (origin
       ...
       (sha256
        (base32
         "1yf4zq1bmp0bvjcq0g030jjjq0r0f23vvin7hy97hh4g978w3gyd"))))
     (build-system gnu-build-system)
     (arguments
